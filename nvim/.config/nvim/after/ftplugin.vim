...
augroup HideCursor
  au!
  au BufLeave,WinLeave,FileType NvimTree,LspSaga set guicursor=n-v-c-sm:block,i-ci-ve:ver2u,r-cr-o:hor20,
  au BufEnter,WinEnter,FileType NvimTree,LspSaga set guicursor=n-c-v:block-Cursor/Cursor-blinkon0,
augroup END
