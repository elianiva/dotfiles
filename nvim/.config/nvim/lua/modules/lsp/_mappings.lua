...
M.lsp_mappings = function()
  ...
  remap('n', 'gd', '<cmd>lua require"lspsaga.provider".preview_definiton()<CR>', {
    noremap = true,
    silent = true,
  })
  ...
  remap('i', '<C-s>', '<cmd>lua vim.lsp.buf.signature_help()<CR>', {
    noremap = true,
    silent = true,
  })
  remap('n', 'gD', '<cmd>lua vim.lsp.diagnostic.show_line_diagnostics()<CR>', {
    noremap = true,
    silent = true,
  })
  remap('n', 'gr', '<cmd>lua require"telescope.builtin".lsp_references()<CR>', {
    noremap = true,
    silent = true,
  })
  remap('n', 'gR', '<cmd>lua vim.lsp.buf.rename()<CR>', {
    noremap = true,
    silent = true,
  })
end
