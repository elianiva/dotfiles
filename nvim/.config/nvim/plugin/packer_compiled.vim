...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "nvim-treesitter-pairs", "playground", "nvim-treesitter-textobjects" },
    loaded = false,
    needs_bufread = true,
  ...
  ["nvim-treesitter-pairs"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/elianiva/.local/share/nvim/site/pack/packer/opt/nvim-treesitter-pairs"
  },
