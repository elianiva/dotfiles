...
_G.packer_plugins = {
  ...
  ["lush.nvim"] = {
    after = { "nvim-web-devicons", "nvim-bufferline.lua" },
  ...
  ["nvim-web-devicons"] = {
    after = { "nvim-nonicons", "nvim-bufferline.lua", "telescope.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-dap.nvim", "telescope-media-files.nvim", "nvim-jdtls", "telescope-frecency.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'enwise', 'nvim-treesitter', 'nvim-treesitter-textobjects', 'gitsigns.nvim', 'nvim-lspconfig'}, { event = "BufRead *" }, _G.packer_plugins)]]
