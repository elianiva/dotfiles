...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lspconfig', 'gitsigns.nvim', 'nvim-treesitter', 'nvim-treesitter-textobjects'}, { event = "BufRead *" }, _G.packer_plugins)]]
